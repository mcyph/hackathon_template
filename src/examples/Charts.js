import {
  BasicPieChart, BasicLineChart, BasicBarChart, EChartsChart, NestedPieChart,
  BoxPlotChart, CandlestickChart, FunnelChart, GaugeChart, HeatmapCartesian,
  SankeyChart, ScatterPlot, SunburstChart, TreeMap
} from "../libraries/charts"
...
let Charts=()=>{
  return <>
    ...
    <p>
      <BasicBarChart
          data={[["plot 1", [["apple", 10], ["pear", 15], ["banana", 5]]],
    ...
    <p>
      <BasicPieChart
          data={ [['apple', 30], ['orange', 60], ['pear', 10]] }
    ...
    <p>
      <FunnelChart
          data={[['apple', 60], ['banana', 40], ['cherry', 20],
                 ['orange', 80], ['pear', 100]]}
    ...
    <h3>Other Charts</h3>
    <h4>Nested Pie Chart</h4>
    <p>
      <NestedPieChart
          innerData={[['Fruit', 50], ['Vegetable', 50]]}
    ...
    <h4>Heat Map Cartesian Chart</h4>
    <p>
      <HeatmapCartesian
